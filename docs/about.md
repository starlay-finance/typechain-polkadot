...
```json
"dependencies": {
	"@starlay-finance/typechain-compiler": "^0.5.16",
...
```bash
$ npx @starlay-finance/typechain-compiler --config typechain.config.json
```
...
```bash
$ npm install @starlay-finance/typechain-polkadot
```
...
```bash
$ npx @starlay-finance/typechain-polkadot --in ./artifacts --out ./typechain-generated
```
